...
$result = $access->getTableContent("offers");
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" data-background-color="green">
                                <h4 style="margin-left: 5%" class="title">Offers</h4>
                                <p style="margin-left: 5%" class="category">Add / Remove Offers</p>
                                ...
                                <table class="table">
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="../OffersImgs/<?php echo $row["img"]; ?>" style="height: 100px; width: auto"></td>
                                            <td><?php echo $row["content"]; ?></td>
                                            <td><?php echo date("d/m/Y", $row["timeInMillis"] / 1000); ?></td>
                                            <td class="td-actions text-right">
                                                <button rel="tooltip" title="Edit" class="btn btn-success btn-simple btn-xs edit-btn" value="<?php echo $row["id"]. ',' .$row["title"]. ',' .$row["img"]. ',' .$row["content"]. ',' . date("d/m/Y", $row["timeInMillis"] / 1000); ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="upload_ad" action="" method="post" enctype="multipart/form-data">
                    ...
                    <input id="offerid" style="display: none;">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <textarea id="content" class="form-control" placeholder="Content" rows="5"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12">
                        <div class="input-group">
                            ...
                            <input id="time" class="form-control" type="date" placeholder="Deadline: <?php echo date("d/m/Y"); ?>"/>
                        </div>
                    </div>
...
<script>
    ...
    $('.remove-btn').click(function(){
        ...
        var dataString = "tblName=" + "offers" + "&dir=" + "OffersImgs" +  "&id="+ $(this).attr("value");
    ...
    $('.edit-btn').click(function(){
        ...
        $('#offerid').val(paramsArr[0]);
        $('#title').val(paramsArr[1]);
        $('#content').val(paramsArr[3]);
        $('#time').val(paramsArr[4]);
        $('#previewing').attr('src', "../OffersImgs/" + paramsArr[2]);
    ...
    $('button#upload-ad-btn').on('click', function(e){
        ...
        $.ajax({
            url: "../addOffer.php", // Url to which the request is send
            type: "POST",
